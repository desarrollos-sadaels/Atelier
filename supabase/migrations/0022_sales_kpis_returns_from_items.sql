-- ============================================================
-- 0022 — sales_kpis: las devoluciones se cuentan desde las prendas
--
...
-- ($600.000). El reporte ya lo corrigió en la 0021; esto lo corrige en la
-- fuente de los KPIs.
--
-- Qué cambia: SOLO `returned_amount` y `returned_count`, con el mismo criterio
-- que `sales_by_seller_channel` (0021):
--
...
-- envío ni movimientos). Depende de `sale_movements` y `sales.shipping_amount`,
-- que siguen sin migración propia.
--
