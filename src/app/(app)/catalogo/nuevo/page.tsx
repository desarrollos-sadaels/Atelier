...
export default function NuevoProductoPage() {
  ...
  const [campaign, setCampaign] = useState("Seleccionar campaña…");
          ...
          <Card>
            ...
            <div className="px-6 pb-6 pt-4">
              <Dropdown
                label="CAMPAÑA"
                value={campaign}
                options={["Seleccionar campaña…"]}
                onChange={setCampaign}
              />
              <div className="mt-4 flex items-center justify-between opacity-60">
                <span className="text-[13px] font-medium">Avisar al pausar por sin stock</span>
                <Toggle defaultOn />
              </div>
              <p className="mt-3 text-[11px] text-mut">Disponible al conectar Meta Ads (próxima fase).</p>
            </div>
          </Card>
        </div>
      </div>
